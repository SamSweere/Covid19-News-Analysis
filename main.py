...
n_gram_list = analysis.n_gram(df)
num_topics = 10

# LDA results
dictionary_LDA = analysis.build_dictionary(n_gram_list)
lda_model, corpus = analysis.lda(n_gram_list, dictionary_LDA, num_topics)
analysis.show_topics(lda_model, num_topics)  # show some intermediate results

# predict (TODO should we preprocess in same way as text?)
doc = read_data.get_body_df(15).body[10]
topic_df = analysis.predict_topic(lda_model, dictionary_LDA, num_topics, [doc])
print(topic_df)
